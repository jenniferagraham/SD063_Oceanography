...
if ismac
    ...
    %f.ladcpup = sprintf('/Volumes/leg/system/ctd_seabird_sbe911plus/acquisition/data/SD063/LADCP/Data/SD063_%03d_SS_S.000', stn);
    f.ladcpdo = sprintf('/Volumes/leg/system/ctd_seabird_sbe911plus/acquisition/data/SD063/LADCP/Data/SD063_%03d_SS_M.000', stn);
    f.res = sprintf('/Volumes/leg/work/scientific_work_areas/oceanography/LADCP/Postprocessing_LDEO_IX_15beta/processed/SD063_%03d_ladcp',stn);
...
elseif ispc % change the drive name accordingly!!
    ...
    %f.ladcpup = sprintf('L:\\system\\ctd_seabird_sbe911plus\\acquisition\\data\\SD063\\LADCP\\Data\\SD063_%03d_SS_S.000',stn);
    f.ladcpdo = sprintf('L:\\system\\ctd_seabird_sbe911plus\\acquisition\\data\\SD063\\LADCP\\Data\\SD063_%03d_SS_M.000',stn);
    f.res = sprintf('L:\\work\\scientific_work_areas\\oceanography\\LADCP\\Postprocessing_LDEO_IX_15beta\\processed\\SD063_%03d_ladcp',stn);
    f.checkpoints = sprintf('L:\\work\\scientific_work_areas\\oceanography\\LADCP\\Postprocessing_LDEO_IX_15beta\\checkpoints');
elseif isunix
    %f.ladcpup = sprintf('/mnt/leg/system/ctd_seabird_sbe911plus/acquisition/data/SD063/LADCP/Data/SD063_%03d_SS_S.000', stn);
    f.ladcpdo = sprintf('/mnt/leg/system/ctd_seabird_sbe911plus/acquisition/data/SD063/LADCP/Data/SD063_%03d_SS_M.000', stn);
    f.res = sprintf('/mnt/leg/work/scientific_work_areas/physics/LADCP/LDEO_IX_15beta/processed/SD063_%03d_ladcp',stn);
