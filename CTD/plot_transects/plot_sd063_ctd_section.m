function plot_sd063_ctd_section(stns,ctds,variable,varargin)

% PLOT_SD063_CTD_SECTION (stns,ctdsstructure,variable,[property_name,property_value])
% by Povl Abrahamsen (August 2024)
% Edited for SDA063 by Rosie Williams (July 2026)
...
m_proj('mercator','lon',minmax(lon),'lat',minmax(lat));
