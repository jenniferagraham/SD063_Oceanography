...
sectionfilenames={'Ssection','Ssectionwarm',...
    ...
    '3mtransect','3mtransect-1','3mtransect-2','3mtransect-3',...
...
%sectionfilenames={'3micefront_section-2','3micefronttowyo','3mhead'};

sectionfilenames={'3micefronttowyo'};
...
%% plot the sections
thefig=figure('Position', [100, 100, 1200, 900]); 
thefig.WindowState = 'maximized'; set(thefig,'Visible','on')
