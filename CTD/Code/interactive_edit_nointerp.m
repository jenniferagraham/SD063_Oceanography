function [ycurrent] = interactive_edit_nointerp(x,y,pres,varname)
...
while stopcode ~= 1
    ...
    acceptcode = say_what(input('Accept edits? (y = 1 / n = 0)\n','s'));
    if acceptcode == 1
        ycurrent = ytemp;
    end
    end
    ...
    stopcode = say_what(input('Finished editing? (y = 1 / n = 0)\n','s'));
