...
if ismac
    ...
    addpath('/Volumes/leg/work/scientific_work_areas/ctd/GSWscripts/gsw_matlab_v3_06_16')
    % postprocessing: directories on Povl's computer & BAS SAN
    % dir_sb='/Volumes/sda/20240717/work/scientific_work_areas/ctd/SBEproc';
    % dir_raw='/Volumes/sda/20240717/system/ctd_seabird_sbe911plus/acquisition/data/SD046/CTD/raw';
    % dir_SBE35='/Volumes/sda/20240717/system/ctd_seabird_sbe911plus/acquisition/data/SD046/CTD/raw';
    % 
    % dir_out='/Users/epab/Povl/SD046/CTD/BASproc';
    % dir_plots='/Users/epab/Povl/SD046/CTD/BASproc/plots';
    % dir_salts='/Users/epab/Povl/SD046/CTD/salts';
...
elseif isunix
    ...
    addpath('/mnt/leg/work/scientific_work_areas/ctd/GSWscripts/gsw_matlab_v3_06_16')
else
    error('Set your paths!');
end

%%%%%Following not needed, so long as use leading commas before cruise, that Matlab says
%%%%%you don't need:
...
%set different cast_fileadd below
...
frame_fileadd='_SS'; % suffix for the rosette: _SS or _Ti

incEvent=1; %include event numbers in filename. Capture in ctdreadGEN
%if you just want event numbers, set to 0 (and adjust batch looping)
...
var2dbQ=0;  %1 for 2db vectors being just long enough for cast, 0 for consistent length
...
varnames={
  ...
  'oxygen1_umol_kg'  8    1   1   1   3   1   'Oxygen 1 (\mumol kg^{-1})'
  'oxygen2_umol_kg'  9    1   1   1   3   1   'Oxygen 2 (\mumol kg^{-1})'
       'turbidity'  0    1   1   1   0   1   'Turbidity (m^{-1} sr^{-1})'
       'BeamTrans'  10    1   1   1   2   1   'Trans (%)'
      ...
      'fluor_ug_l'  12    1   1   1   1   1   'Chl a (\mug l^{-1})'
           'pumps'  14    1   1   0   0   0   'pump'     %e.g. for not saving from this point on
            'flag'  17    1   1   0   0   0   'flag'
             'par'  13    1   1   1   4   1   'PAR (\mumol m^{-2} sec^{-1})'
       ...
       'PressTemp'   0    1   1   0   0   0   'pressure temp (^oC)' %e.g. for including in output but not processing
         ...
         'potemp2'  -1    0   1   0   0   1   'Pot Temp 2 (^oC)'
          ...
          'Ctemp'  -1    0   1   0   0   1   'Pot Temp (^oC)'
            'sigma0'  -1    0   1   0   0   1   '\sigma_0 (kg m^{-3})'
            'sigma2'  -1    0   1   0   0   1   '\sigma_2 (kg m^{-3})'
            'sigma4'  -1    0   1   0   0   1   '\sigma_4 (kg m^{-3})'
           'depth'  -1    0   1   0   0   1   'Depth (m)' %set third column to 0 if not wanted
  'oxygen_umol_kg'  -1    0   1   0   0   1   'Oxygen (\mumol kg^{-1})'
            'cdom'  0    1   1   1   0   1   'CDOM (QSU)'
         } ; 
